...
public class EarthquakeInsuranceController extends BaseController {
     ...
     * @return The singleton instance of the EarthquakeInsuranceController class 
     */
    public static EarthquakeInsuranceController getInstance() {
        if (null == instance) {
     ...
     */
    public void getEarthquakeAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                try {
                    _request = _buildGetEarthquakeRequest(subDomain, insurancePolicyId, insurancePolicyType, xApiKey);
                } catch (Exception e) {
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            BaseModelEarthquake returnValue = _handleGetEarthquakeResponse(_context);
    ...
    /**
     * Builds the HttpRequest object for getEarthquake
     */
    private HttpRequest _buildGetEarthquakeRequest(
                final String subDomain,
                final int insurancePolicyId,
                final int insurancePolicyType,
    ...
    /**
     * Processes the response for getEarthquake
     * @return An object of type BaseModelEarthquake
     */
    private BaseModelEarthquake _handleGetEarthquakeResponse(HttpContext _context)
        ...
        BaseModelEarthquake _result = APIHelper.deserialize(_responseBody,
                                                        new TypeReference<BaseModelEarthquake>(){});
