...
public class BaseModelTrakingCode 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = -6942192966886285865L;
    private boolean isSuccess;
    private int status;
    private List<TrackingCode> message;
     ...
     */
    @JsonGetter("message")
    public List<TrackingCode> getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (List<TrackingCode> value) { 
        this.message = value;
