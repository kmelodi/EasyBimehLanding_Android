...
public class BaseModelInsurancePolicyTracking 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = 2054250708575630572L;
    private boolean isSuccess;
    private int status;
    private InsurancePolicyTracking message;
     ...
     */
    @JsonGetter("message")
    public InsurancePolicyTracking getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (InsurancePolicyTracking value) { 
        this.message = value;
