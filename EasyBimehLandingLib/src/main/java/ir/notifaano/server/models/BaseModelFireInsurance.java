...
public class BaseModelFireInsurance 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = -2244220040618579271L;
    private boolean isSuccess;
    private int status;
    private FireInsurance message;
     ...
     */
    @JsonGetter("message")
    public FireInsurance getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (FireInsurance value) { 
        this.message = value;
