...
public class BaseModelElectronicEquipmentInsurance 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = -7215077367521844671L;
    private boolean isSuccess;
    private int status;
    private ElectronicEquipmentInsurance message;
     ...
     */
    @JsonGetter("message")
    public ElectronicEquipmentInsurance getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (ElectronicEquipmentInsurance value) { 
        this.message = value;
