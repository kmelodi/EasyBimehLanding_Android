...
public class CarBrandTips 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = -325441681379321884L;
    private boolean isSuccess;
    private int status;
    private List<CarBrandTipsModel> message;
     ...
     */
    @JsonGetter("message")
    public List<CarBrandTipsModel> getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (List<CarBrandTipsModel> value) { 
        this.message = value;
