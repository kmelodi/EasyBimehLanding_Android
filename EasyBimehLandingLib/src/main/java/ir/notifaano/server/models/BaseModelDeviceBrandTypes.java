...
public class BaseModelDeviceBrandTypes 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = 4309478140297553967L;
    private boolean isSuccess;
    private int status;
    private List<DeviceBrandTypes> message;
     ...
     */
    @JsonGetter("message")
    public List<DeviceBrandTypes> getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (List<DeviceBrandTypes> value) { 
        this.message = value;
