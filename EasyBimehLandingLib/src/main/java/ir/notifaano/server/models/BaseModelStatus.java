...
public class BaseModelStatus 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = 7504955114733022604L;
    private boolean isSuccess;
    private int status;
    private List<Status> message;
     ...
     */
    @JsonSetter("message")
    public void setMessage (List<Status> value) { 
        this.message = value;
