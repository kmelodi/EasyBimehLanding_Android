...
public class BaseModelDamageType 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = -4688592557793439045L;
    private boolean isSuccess;
    private int status;
    private List<DamageType> message;
     ...
     */
    @JsonGetter("message")
    public List<DamageType> getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (List<DamageType> value) { 
        this.message = value;
