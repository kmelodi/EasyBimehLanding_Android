...
public class BaseModelTravelInsurance 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = -3451007345789265326L;
    private boolean isSuccess;
    private int status;
    private TravelInsurance message;
     ...
     */
    @JsonGetter("message")
    public TravelInsurance getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (TravelInsurance value) { 
        this.message = value;
