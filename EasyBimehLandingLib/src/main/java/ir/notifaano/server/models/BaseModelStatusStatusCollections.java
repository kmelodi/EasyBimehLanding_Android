...
public class BaseModelStatusStatusCollections 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = 6115907954496536122L;
    private boolean isSuccess;
    private int status;
    private List<StatusStatusCollections> message;
     ...
     */
    @JsonGetter("message")
    public List<StatusStatusCollections> getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (List<StatusStatusCollections> value) { 
        this.message = value;
