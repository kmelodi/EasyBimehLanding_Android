...
public class BaseModelElevatorInsurance 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = -4366767920665138097L;
    private boolean isSuccess;
    private int status;
    private ElevatorInsurance message;
     ...
     */
    @JsonGetter("message")
    public ElevatorInsurance getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (ElevatorInsurance value) { 
        this.message = value;
