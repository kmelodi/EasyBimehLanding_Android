...
public class BaseModelFaqInsuranceCentre 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = -7424523568484856175L;
    private boolean isSuccess;
    private int status;
    private List<FaqInsuranceCentre> message;
     ...
     */
    @JsonGetter("message")
    public List<FaqInsuranceCentre> getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (List<FaqInsuranceCentre> value) { 
        this.message = value;
