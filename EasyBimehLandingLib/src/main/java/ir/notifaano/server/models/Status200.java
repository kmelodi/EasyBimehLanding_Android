...
public class Status200 
    ...
    private static final long serialVersionUID = 2159210603266361479L;
    private boolean isSuccess;
    private int status;
    private GetAccessTokenUserInfo message;
     ...
     */
    @JsonGetter("message")
    public GetAccessTokenUserInfo getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (GetAccessTokenUserInfo value) { 
        this.message = value;
