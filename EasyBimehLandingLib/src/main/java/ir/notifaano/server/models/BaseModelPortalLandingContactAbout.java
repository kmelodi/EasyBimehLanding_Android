...
public class BaseModelPortalLandingContactAbout 
        extends java.util.Observable
        implements java.io.Serializable {
    private static final long serialVersionUID = 9093364331942514088L;
    private boolean isSuccess;
    private int status;
    private PortalLandingContactAbout message;
     ...
     */
    @JsonGetter("message")
    public PortalLandingContactAbout getMessage ( ) { 
        return this.message;
    }
     ...
     */
    @JsonSetter("message")
    public void setMessage (PortalLandingContactAbout value) { 
        this.message = value;
