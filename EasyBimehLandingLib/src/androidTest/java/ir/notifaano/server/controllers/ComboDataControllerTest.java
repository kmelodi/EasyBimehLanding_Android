...
import ir.notifaano.server.controllers.ComboDataController;
...
@LargeTest
public class ComboDataControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static ComboDataController controller;
    ...
    public static void setUpClass() {
        controller = getClient().getComboData();
    }
