...
import ir.notifaano.server.controllers.LiabilityDoctorInsuranceController;
...
@LargeTest
public class LiabilityDoctorInsuranceControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static LiabilityDoctorInsuranceController controller;
    ...
    public static void setUpClass() {
        controller = getClient().getLiabilityDoctorInsurance();
    }
