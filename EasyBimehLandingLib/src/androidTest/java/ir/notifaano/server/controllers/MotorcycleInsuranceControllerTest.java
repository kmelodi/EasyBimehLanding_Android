...
import ir.notifaano.server.controllers.MotorcycleInsuranceController;
...
@LargeTest
public class MotorcycleInsuranceControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static MotorcycleInsuranceController controller;
    ...
    public static void setUpClass() {
        controller = getClient().getMotorcycleInsurance();
    }
