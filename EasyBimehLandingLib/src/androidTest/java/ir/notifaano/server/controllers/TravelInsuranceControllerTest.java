...
import ir.notifaano.server.controllers.TravelInsuranceController;
...
@LargeTest
public class TravelInsuranceControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static TravelInsuranceController controller;
    ...
    public static void setUpClass() {
        controller = getClient().getTravelInsurance();
    }
