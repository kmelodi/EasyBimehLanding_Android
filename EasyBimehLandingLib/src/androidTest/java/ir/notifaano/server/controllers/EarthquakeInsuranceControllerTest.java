...
import ir.notifaano.server.controllers.EarthquakeInsuranceController;
...
@LargeTest
public class EarthquakeInsuranceControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static EarthquakeInsuranceController controller;
    ...
    public static void setUpClass() {
        controller = getClient().getEarthquakeInsurance();
    }
