...
import ir.notifaano.server.controllers.ThirdPartyInsuranceController;
...
@LargeTest
public class ThirdPartyInsuranceControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static ThirdPartyInsuranceController controller;
    ...
    public static void setUpClass() {
        controller = getClient().getThirdPartyInsurance();
    }
