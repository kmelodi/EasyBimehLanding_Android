...
import ir.notifaano.server.controllers.TrackingDamageController;
...
@LargeTest
public class TrackingDamageControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static TrackingDamageController controller;
    ...
    public static void setUpClass() {
        controller = getClient().getTrackingDamage();
    }
