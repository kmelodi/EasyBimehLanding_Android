...
import ir.notifaano.server.controllers.FileManagerController;
...
@LargeTest
public class FileManagerControllerTest extends ControllerTestBase {
    ...
    public static void setUpClass() {
        controller = getClient().getFileManager();
    }
