...
import ir.notifaano.server.controllers.ElevatorInsuranceController;
...
@LargeTest
public class ElevatorInsuranceControllerTest extends ControllerTestBase {
    ...
    public static void setUpClass() {
        controller = getClient().getElevatorInsurance();
    }
