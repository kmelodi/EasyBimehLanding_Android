...
import ir.notifaano.server.EasyBimehLandingClient;
import ir.notifaano.server.testing.HttpCallBackCatcher;
...
public class ControllerTestBase {
     ...
     * @return
     */
    protected static EasyBimehLandingClient getClient() {
        if (client == null) {
