...
import ir.notifaano.server.controllers.OtherInsuranceTypesController;
...
@LargeTest
public class OtherInsuranceTypesControllerTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static OtherInsuranceTypesController controller;
    ...
    public static void setUpClass() {
        controller = getClient().getOtherInsuranceTypes();
    }
