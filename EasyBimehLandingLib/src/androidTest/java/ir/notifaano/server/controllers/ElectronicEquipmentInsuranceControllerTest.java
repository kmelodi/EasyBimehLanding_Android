...
public class ElectronicEquipmentInsuranceControllerTest extends ControllerTestBase {
    ...
    public void testDiviceFranchisee() throws Throwable {
        ...
        APICallBackCatcher<BaseModelDiviceFranchisee> response = new APICallBackCatcher<BaseModelDiviceFranchisee>();
        controller.setHttpCallBack(httpResponse);
        controller.getDiviceFranchiseeAsync(deviceModelId, xApiKey, response);
